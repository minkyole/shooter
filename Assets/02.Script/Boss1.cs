...
public class Boss1 : MonoBehaviour
{
    ...
    public GameObject levelWinScree;
    ...
    void Update()
    {
        ...
        if (phase1)
        {
            theBoss.transform.position = Vector3.MoveTowards(theBoss.transform.position,
                                                            new Vector3(topPosition.position.x,
                                                            theBoss.transform.position.y,
        ...
        if (!phase0 && !phase1)
        {
            ...
            {
                theBoss.transform.position = Vector3.MoveTowards(theBoss.transform.position,
                                                                new Vector3(theBoss.transform.position.x,
                                                                bottomPosition.position.y,
                                                                theBoss.transform.position.z),
        ...
        if (phase2)
        {
            ...
            if (topHandHealth > 1000 && bottomHandHealth > 1000)
            {
                phase2 = false;
                phase3 = true;
            }
